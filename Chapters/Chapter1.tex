...
At baseline level, I used both descriptive and inferential statistics to carry out analysis of participants' characteristics. I analysed demography's informations and self-determination to use cellphone of two sets of participants. The first set of participants consisted of seven beneficiaries while the second set of participants consisted of nine intermediaries. Table 1 below shows the mean age with its respective standard deviation for each set of participants. Beneficiaries had a mean age of 48 years old (SD: 7.9 years) while intermediaries had a mean age of 14 years (SD: 4.3 years).
\newline
\newline
...
\newline
Table
Figure 2 below shows a cluster bar chart for each scale I used for calculating the overall "{\textit{intrinsic motivation to use cellphone}". There are six scales and these are;\textit{} 
