...
\userquote{\textbf{Jane}, a female beneficiary from Athlone, 35 yrs old} {``We would fight over it[the app]. Because he always wants to be on the phone. Always always.''}
...
\item{\textbf{Gamification comparison}}: This kind of comparison motivated intermediaries to check the app more often compared to when they were in logbook condition as highlighted on the findings of reported above(sub section \ref{usageoutcome}).
...
Interest of intermediaries or pairs in general varied as some valued more on the social relatedness brought by the intervention while other where concerned about achievement (i.e. dominating others in competitions). Gamification appeared to be the most dominant factor that influenced usage as we have already seen that the frequency of usage showed a higher value in gamification when compared to logbook. 
\userquote{\textbf{Pair H}, (Daniel 15yrs-intermediary, Jennifer 35-beneficiary)} {``We were not talking to others because all we wanted was to win.''} 
